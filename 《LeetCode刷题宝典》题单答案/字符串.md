...
#### [208. 实现 Trie (前缀树)（中等难度）](https://leetcode-cn.com/problems/implement-trie-prefix-tree/)

#### [剑指 Offer II 062. 实现前缀树（中等难度）](https://leetcode-cn.com/problems/QC3q1f/)
...
#### [820. 单词的压缩编码（中等难度）](https://leetcode-cn.com/problems/short-encoding-of-words/)
...
### 3、允许且必须变化一个字符后再匹配的字典树

#### [676. 实现一个魔法字典（中等难度）](https://leetcode-cn.com/problems/implement-magic-dictionary/)

#### [剑指 Offer II 064. 神奇的字典（中等难度）](https://leetcode-cn.com/problems/US1pGT/)
